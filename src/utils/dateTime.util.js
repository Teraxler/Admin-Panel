...
function formattingDateTime(dateTime) {
  const stringDateTime = {
    ...
    yearStr: addPadding(dateTime.year, 4),
    monthStr: addPadding(dateTime.month),
    dayStr: addPadding(dateTime.day),
    hourStr: addPadding(dateTime.hour),
    minuteStr: addPadding(dateTime.minute),
    secondStr: addPadding(dateTime.second),
...
function calculateRelativeDateTimeDifference(
...
function calculateNumberOfDaysOnMonth(currentYear, currentMonth) {
...
function calculateWeeksOfMonth(year, month) {
  const daysOfMonth = calculateNumberOfDaysOnMonth(year, month);
...
export {
  calculateNumberOfDaysOnMonth,
  convertMilliSecondsToDateTime,
  convertMonthToMonthName,
  calculateRelativeDateTimeDifference,
  formattingDateTime,
  normalizeDateTime,
